...
class ChittagongPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint_16_fill.color = color ?? _filColor;
    ...
    paint_17_fill.color = color ?? _filColor;
    ...
    paint_18_fill.color = color ?? _filColor;
    ...
    paint_19_fill.color = color ?? _filColor;
    ...
    paint_20_fill.color = color ?? _filColor;
